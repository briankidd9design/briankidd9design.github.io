	...
	$('.c-form-box form').submit(function(e) {
	    ...
	    $.ajax({
	        ...
	        success: function(json) {	            
				...
				$('.c-form-box form label[for="c-form-antispam"] .contact-error').fadeOut('fast', function(){
				...
				json.antispamMessage == '') {
	            	...
	            	this_form_parent.find('.c-form-bottom').fadeOut('fast', function() {
	            		this_form_parent.append('<p>Thanks for contacting Brian Kidd! He will get back to you very soon.</p>');
	            		// reload background
